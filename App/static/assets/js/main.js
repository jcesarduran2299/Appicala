...
//const WindowLocationPathname = String("/" + window.location.pathname.split("/").pop());
const WindowLocationPathname = String(window.location.pathname);
$('.menu-item a').each(function () {
    //if ($(this).attr('href') === WindowLocationPathname) {
    if (WindowLocationPathname.includes($(this).attr('href'))) {
        //$(this).parent().addClass('active');
        $(this).closest('.menu-item').addClass('active');
        $(this).closest('.menu-item').parent().closest('.menu-item').addClass('active open');
        $(this).closest('.menu-item').parent().parent().parent().closest('.menu-item').addClass('active open');
    }
});